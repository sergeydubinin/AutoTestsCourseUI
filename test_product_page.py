...
@pytest.mark.parametrize("value_link", ["offer0", "offer1", "offer2", "offer3", "offer4", "offer5", "offer6",
                                        pytest.param("offer7", marks=pytest.mark.xfail), "offer8", "offer9"])
def test_guest_can_add_product_to_basket(browser, value_link):
...
class TestUserAddToBasketFromProductPage:
    ...
    def setup(self, browser):
        ...
        page.open()
        email = str(time.time()) + "@dsd.org"
        password = "123456789Dsd"
